...
HD_PWD='C:/Users/Dusan/Desktop/standby_sparing/standby_sparing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log voter_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source voter_wrapper.tcl -notrace
