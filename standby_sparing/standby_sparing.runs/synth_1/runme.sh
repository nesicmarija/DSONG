...
HD_PWD='C:/Users/Dusan/Desktop/standby_sparing/standby_sparing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log voter_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source voter_wrapper.tcl
