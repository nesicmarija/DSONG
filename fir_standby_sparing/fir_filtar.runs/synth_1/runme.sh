...
HD_PWD='C:/Users/Dusan/Desktop/master_sve/GITHAB/DSONG/fir_standby_sparing/fir_filtar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_fault_tolerant.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_fault_tolerant.tcl
