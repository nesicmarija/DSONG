...
HD_PWD='C:/Users/Dusan/Desktop/master_sve/GITHAB/DSONG/fir_standby_sparing/fir_filtar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_fault_tolerant.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fir_fault_tolerant.tcl -notrace
